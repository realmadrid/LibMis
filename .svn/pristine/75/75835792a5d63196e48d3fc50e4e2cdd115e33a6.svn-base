  ...
  <div id="main-content"> <!-- Main Content Section with everything -->
            ...
            <div class="content-box"><!-- Start Content Box -->
					...
					<div class="tab-content default-tab">
                    		...
                    		<form action="admin/roleEdit" method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>角色名</label>
										...
										<input class="text-input small-input" type="text" id="small-input" name="role.name" value="<s:property value="role.name"/>"/> 
								...
								<p>
									<label>权限</label>
									<s:iterator value="authorities" var="a">
										<input type="checkbox" name="authorityIds" value='<s:property value="#a.id"/>'/>
