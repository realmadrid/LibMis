  ...
  <div id="main-content"> <!-- Main Content Section with everything -->
            ...
            <div class="content-box"><!-- Start Content Box -->
					...
					<div class="tab-content default-tab">
                    		...
                    		<form action="admin/bookAdd" method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>书名</label>
										<input class="text-input small-input" type="text" id="small-input" name="book.name" /> 
								...
								<p>
									<label>类别</label>
										<input class="text-input small-input" type="text" id="small-input" name="book.category" /> 
								</p>
			
								<p>
									<label>语言</label>              
									<select name="book.language" class="small-input">
								...
								<p>
									<label>作者</label>
										<input class="text-input small-input" type="text" id="small-input" name="book.author" /> 
								</p>
								
								<p>
									<label>译者</label>
										<input class="text-input small-input" type="text" id="small-input" name="book.translator" /> 
								</p>
								
								<p>
									<label>出版社</label>
										<input class="text-input small-input" type="text" id="small-input" name="book.publisher" /> 
								</p>
								
								<p>
									<label>出版时间</label>
										<input class="text-input small-input" type="text" id="small-input" name="book.pubtime" /> 
								</p>
								
								<p>
									<label>isbn</label>
										<input class="text-input small-input" type="text" id="small-input" name="book.isbn" /> 
								</p>
								
								<p>
									<label>价格</label>
										<input class="text-input small-input" type="text" id="small-input" name="book.price" /> 
								</p>
								
								<p>
									<label>备注</label>
									<textarea class="text-input textarea wysiwyg" id="textarea" cols="79" rows="15" name="book.remark"></textarea>
								</p>
