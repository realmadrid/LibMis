            ...
            <div class="content-box"><!-- Start Content Box -->
					...
					<div class="tab-content default-tab">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>用户名</label>
										<input class="text-input small-input" type="text" id="small-input" name="user.username" value="<s:property value="user.username"/>"/> 									
								</p>
								<p>
									<label>密码</label>
								...
								<p>
									<label>真实姓名</label>
									<input class="text-input small-input" type="text" id="small-input" name="user.realname" value="<s:property value="user.realname"/>"/> 
								</p>
								<p>
									<label>身份证</label>
									<input class="text-input small-input" type="text" id="small-input" name="user.idnumber" value="<s:property value="user.idnumber"/>"/> 
								</p>
								<p>
									<label>性别</label>
								...
								<p>
									<label>电话号</label>
										<input class="text-input small-input" type="text" id="small-input" name="user.cellphone" value="<s:property value="user.cellphone"/>"/> 
										
								</p>
								<p>
									<label>邮箱</label>
									<input class="text-input small-input" type="text" id="small-input" name="user.email" value="<s:property value="user.email"/>"/> 
								</p>
								<p>
									<label>地址</label>
									<input class="text-input small-input" type="text" id="small-input" name="user.address" value="<s:property value="user.address"/>"/> 
								</p>
								<p>
									<label>借书上限</label>
									<input class="text-input small-input" type="text" id="small-input" name="user.limitNumber" value="<s:property value="user.limitNumber"/>"/> 
								</p>
								<p>
									<label>已借书</label>
									<input class="text-input small-input" type="text" id="small-input" name="user.borrowed" value="<s:property value="user.borrowed"/>" readonly="readonly"/> 
								</p>
								<p>
									<label>角色</label>
