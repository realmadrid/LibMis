								...
								<table>
									<tbody>
										...
										<tr>
											...
											<td>
												当前借阅( <s:property value="user.borrowed"/> ) / 最大借阅( <s:property value="user.limitNumber"/> )
											</td>
										</tr>
									</tbody>
								</table>
								<div class="wrapper">
									<a href="userInfoEditInput" class="link1" style="margin-left:80px;"><em><b>修改个人信息</b>
									</em>
									</a>
									<a href="changePasswordInput" class="link1" style="margin-right:80px;float:right"><em><b>修改密码</b>
									</em>
									</a>
