					...
					<div class="inside">
						<div class="container">
							<div class="aside">
								...
								<div class="wrapper">
									<a href="#" class="link1"><em><b>更多服务..</b> </em> </a>
								</div>
							</div>
							<div class="content">
								<h3>
								...
								<form id="changePassword" action="changePassword" method="post">
									...
									<%if(success!=null&&success.equals("true")){
										%>
										<span class="input-notification success png_bg">密码修改成功!</span> <!-- Classes for input-notification: success, error, information, attention -->
										<%
									}else if(success!=null&&success.equals("false")){
										%>
										<center style="font:20px bolder '幼圆';"><font color="#FF8080"><s:fielderror></s:fielderror></font></center>
									<%} %>
									</p>
									<table>
										<tbody>
									...
									<div class="wrapper">
										<a href="javascript:document.getElementById('changePassword').submit()" class="link1" style="margin-right:80px;float:right"><em><b>修改密码</b></em></a>
									</div>
								</form>
							</div>
							<div class="clear"></div>
